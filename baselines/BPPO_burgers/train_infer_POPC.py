...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", default=116, type=int)
    ...
    parser.add_argument('--pde_1d_surrogate_model_checkpoint', type=str, default='surrogate_model/POPC/', metavar='N',
                        help='test batch size (default: 256)')
    ...
    def evaluate(seed, eval_episodes, s_0, test_target, test_u_full):
        ...
        logs['J_actual_rl2'] = total_rl2  # .mean(0)
        logs['f'] = total_f
