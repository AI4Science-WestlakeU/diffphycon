...
from scripts.utils import  soft_update, hard_update
from scripts.net_2d_pob import GaussianPolicy, QNetwork, DeterministicPolicy, weights_init_


class SAC_pob(object):
    ...
    def update_parameters(self, memory, batch_size, updates, reward_alpha, reg_lambda):
        ...
        return qf1_loss.item(), qf2_loss.item(), policy_loss.item(), alpha_loss.item(), alpha_tlogs.item(), self.policy.state_dict()
            # critic_1_loss, critic_2_loss, policy_loss, ent_loss, alpha, policy_para
